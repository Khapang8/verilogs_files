...
REM
REM Generated by Vivado on Wed Nov 19 21:29:52 +0530 2025
...
echo "xvlog --incr --relax -prj universal_adder_tb_vlog.prj"
call xvlog  --incr --relax -prj universal_adder_tb_vlog.prj -log xvlog.log
