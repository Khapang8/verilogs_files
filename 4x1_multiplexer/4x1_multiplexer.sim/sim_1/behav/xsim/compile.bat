...
REM
REM Generated by Vivado on Fri Nov 14 17:50:40 +0530 2025
...
echo "xvlog --incr --relax -prj tb_mux4x1_vlog.prj"
call xvlog  --incr --relax -prj tb_mux4x1_vlog.prj -log xvlog.log
