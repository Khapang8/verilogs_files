...
REM
REM Generated by Vivado on Wed Nov 05 18:32:11 +0530 2025
...
echo "xvlog --incr --relax -prj tb_boolean_exp_vlog.prj"
call xvlog  --incr --relax -prj tb_boolean_exp_vlog.prj -log xvlog.log
