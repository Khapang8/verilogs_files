...
REM
REM Generated by Vivado on Fri Nov 07 15:56:38 +0530 2025
...
echo "xvlog --incr --relax -prj tb_decoder_2to4_vlog.prj"
call xvlog  --incr --relax -prj tb_decoder_2to4_vlog.prj -log xvlog.log
