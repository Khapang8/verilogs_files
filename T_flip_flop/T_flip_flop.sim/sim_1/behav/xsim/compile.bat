...
REM
REM Generated by Vivado on Wed Nov 19 22:02:47 +0530 2025
...
echo "xvlog --incr --relax -prj tb_T_flipflop_vlog.prj"
call xvlog  --incr --relax -prj tb_T_flipflop_vlog.prj -log xvlog.log
