...
REM
REM Generated by Vivado on Fri Nov 14 19:08:33 +0530 2025
...
call xsim  tb_d_flipflop_behav -key {Behavioral:sim_1:Functional:tb_d_flipflop} -tclbatch tb_d_flipflop.tcl -log simulate.log
