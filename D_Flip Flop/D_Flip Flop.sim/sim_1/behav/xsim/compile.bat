...
REM
REM Generated by Vivado on Fri Nov 14 19:08:31 +0530 2025
...
echo "xvlog --incr --relax -prj tb_d_flipflop_vlog.prj"
call xvlog  --incr --relax -prj tb_d_flipflop_vlog.prj -log xvlog.log
