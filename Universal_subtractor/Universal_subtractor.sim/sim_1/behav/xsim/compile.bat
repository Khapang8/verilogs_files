...
REM
REM Generated by Vivado on Fri Nov 14 18:41:54 +0530 2025
...
echo "xvlog --incr --relax -prj tb_subtractor4_vlog.prj"
call xvlog  --incr --relax -prj tb_subtractor4_vlog.prj -log xvlog.log
