...
REM
REM Generated by Vivado on Wed Nov 19 17:24:51 +0530 2025
...
echo "xvlog --incr --relax -prj tb_counter_0_3_5_6_TFF_vlog.prj"
call xvlog  --incr --relax -prj tb_counter_0_3_5_6_TFF_vlog.prj -log xvlog.log
