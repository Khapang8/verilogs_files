...
REM
REM Generated by Vivado on Thu Nov 06 19:17:01 +0530 2025
...
echo "xvlog --incr --relax -prj tb_priority_encoder_4to2_vlog.prj"
call xvlog  --incr --relax -prj tb_priority_encoder_4to2_vlog.prj -log xvlog.log
