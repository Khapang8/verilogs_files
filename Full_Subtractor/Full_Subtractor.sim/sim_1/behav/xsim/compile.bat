...
REM
REM Generated by Vivado on Fri Nov 14 18:16:20 +0530 2025
...
echo "xvlog --incr --relax -prj tb_full_subtractor_vlog.prj"
call xvlog  --incr --relax -prj tb_full_subtractor_vlog.prj -log xvlog.log
